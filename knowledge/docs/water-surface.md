...
`water-surface` 用 Cesium polygon entity 和 `GeoWaterSurfaceMaterial` shader 渲染动态水面。材质参考 Three.js 官方 `Water`/`Water2` 示例的视觉思路，使用程序化法线扰动、Fresnel 反射、折射色彩混合和流向动画，适合河流、湖泊、洪水淹没面、水位变化和水务大屏。
